...
Opening a pull request will trigger a[workflow](../.github/workflows/titanic_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/titanic_project/titanic_project-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/titanic_project/titanic_project-model)
. 
