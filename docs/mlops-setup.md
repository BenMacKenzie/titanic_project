...
git add README.md docs .gitignore titanic_project/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[titanic_project/databricks.yml](../titanic_project/databricks.yml) file.
...
Follow the instructions in [titanic_project/resources/README.md](../titanic_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../titanic_project/resources/README.md)  to propose, test, and deploy
