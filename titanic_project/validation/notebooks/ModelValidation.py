...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``titanic_project/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in titanic_project/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in titanic_project/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-titanic_project-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.titanic_project.titanic_project-model", "Full (Three-Level) Model Name")
